...
export default function RoutineViewer({ routine }) {
  ...
  // Mobile: toggle between "grid" (full week) and "day" (single-day) view
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.viewToggle}>
        <button
          className={`${styles.viewToggleBtn} ${mobileViewMode === "grid" ? styles.viewToggleBtnActive : ""}`}
          onClick={() => setMobileViewMode("grid")}
        >
          📊 Grid
        </button>
        <button
          className={`${styles.viewToggleBtn} ${mobileViewMode === "day" ? styles.viewToggleBtnActive : ""}`}
      ...
      {/* ─── TOOLBAR ─── */}
      <div className={styles.toolbar} data-hidden={mobileViewMode === "day" ? undefined : undefined}>
      ...
      {/* ─── DESKTOP GRID ─── */}
      <div className={styles.desktopGridWrap} data-hidden={mobileViewMode === "day" ? "true" : undefined}>
      ...
      <div className={styles.mobileView} data-hidden={mobileViewMode === "grid" ? "true" : undefined}>
        {/* Day pill strip */}
