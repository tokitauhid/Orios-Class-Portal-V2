...
/**
 * Weekly routine data.
 * Structure mirrors the legacy format for admin panel compatibility.
 * - timeSlots: ordered array of time strings
 * - days: ordered array of day names
 * - schedule: map of day → array of slots (null = free period)
 *   Each slot index corresponds to the same index in timeSlots.
 */
export const mockWeeklyRoutine = {
  timeSlots: ["8:00", "9:00", "10:00", "11:00", "12:00", "1:00", "2:00", "3:00"],
  days: ["Saturday", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday"],
  schedule: {
    Saturday: [
      null,
      { subjectId: "eee-1201", teacher: "Dr. Rahman", room: "Room 301", type: "lecture" },
      { subjectId: "phy-1201", teacher: "Prof. Ahmed", room: "Room 205", type: "lecture" },
      null,
      null, // break
      { subjectId: "math-1201", teacher: "Dr. Khan", room: "Room 102", type: "lecture" },
      null,
      null,
    ],
    Sunday: [
      ...
      { subjectId: "eee-1201", teacher: "Dr. Rahman", room: "Room 301", type: "lecture" },
      null,
      { subjectId: "cse-1201", teacher: "Ms. Fatima", room: "Lab 4", type: "lab" },
      null, // break
      { subjectId: "phy-1201", teacher: "Prof. Ahmed", room: "Room 205", type: "lecture" },
      null,
      null,
    ...
    Monday: [
      null,
      { subjectId: "phy-1201", teacher: "Prof. Ahmed", room: "Room 205", type: "lecture" },
      { subjectId: "eee-1201", teacher: "Dr. Rahman", room: "Lab 3", type: "lab" },
      { subjectId: "eee-1201", teacher: "Dr. Rahman", room: "Lab 3", type: "lab" },
      null, // break
      { subjectId: "math-1201", teacher: "Dr. Khan", room: "Room 102", type: "lecture" },
      null,
    ...
    Tuesday: [
      { subjectId: "cse-1201", teacher: "Ms. Fatima", room: "Room 401", type: "lecture" },
      { subjectId: "math-1201", teacher: "Dr. Khan", room: "Room 102", type: "lecture" },
      { subjectId: "phy-1201", teacher: "Prof. Ahmed", room: "Room 205", type: "lecture" },
      null,
      null, // break
    ...
    Wednesday: [
      ...
      { subjectId: "cse-1201", teacher: "Ms. Fatima", room: "Lab 4", type: "lab" },
      null, // break
      { subjectId: "phy-1201", teacher: "Prof. Ahmed", room: "Lab 2", type: "lab" },
      { subjectId: "phy-1201", teacher: "Prof. Ahmed", room: "Lab 2", type: "lab" },
      null,
    ],
    Thursday: [
...
export const mockFeatures = [
  ...
  {
    title: "Schedule",
    description: "Weekly routine and daily planner.",
    href: "/schedule",
    icon: "CalendarDays",
  },
  {
...
export const mockAdmins = [
  {
    id: 1,
    email: "super@orios.edu",
    password: "superpassword",
    role: "super_admin",
  },
  {
    id: 2,
    email: "admin@orios.edu",
